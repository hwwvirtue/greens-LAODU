...
void loop()
{
  ...
  if(Serial3.available())
  {
    ...
    Point_speed_Serial[0]=0x5DC;
    Point_speed_Serial[1]=0x5DC;
    left1=Point_speed_Serial[0] >>8;
    right1=Point_speed_Serial[0] &0xFF;
    left2=Point_speed_Serial[1] >>8;
    right2=Point_speed_Serial[1] &0xFF;
    Serial3.write(0xAA);
    delay(10);
    Serial3.write(left1);
    delay(10);
